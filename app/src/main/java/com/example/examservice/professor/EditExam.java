...
public class EditExam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.professor_edit_exam);

        etName = findViewById(R.id.examNameEdit);
        etInfo = findViewById(R.id.examInfoEdit);
        etFrom = findViewById(R.id.examAvailableFromEdit);
        etTo = findViewById(R.id.examAvailableToEdit);
        spinnerLearning = findViewById(R.id.examIsLearningReqEditEspinner);
        etDuration = findViewById(R.id.examDurationTimeEdit);
        etAttempts = findViewById(R.id.examMaxAttemptsEdit);
        etQuestions = findViewById(R.id.examMaxQuestionsEdit);

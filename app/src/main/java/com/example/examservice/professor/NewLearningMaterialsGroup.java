...
public class NewLearningMaterialsGroup extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.professor_new_learning_materials_group);

            etName = findViewById(R.id.newProfMaterialGroupNameEditText);
            materialsList = new ArrayList<>();

            recyclerView = findViewById(R.id.littleProfMaterialsListView);
        ...
        public void addGroup(View view) {
            ...
            int groupId = MainProfessorActivity.groupsCount;
            groupId ++ ;

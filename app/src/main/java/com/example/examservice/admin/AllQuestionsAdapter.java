...
public class AllQuestionsAdapter extends RecyclerView.Adapter<AllQuestionsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(@NonNull final View itemView){
            ...
            buttonDelete = itemView.findViewById(R.id.onAdminQuestionDeleteClickButton);
        }
    }
    ...
    public AllQuestionsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.admin_question_row, parent, false);
        return new AllQuestionsAdapter.ViewHolder(view);
    }
